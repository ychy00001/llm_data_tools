...
# 用来配置的变量
base_dir = "/data/project/llm_data_tools/data/wiki_en"
...
log = Logger('./log/wiki_en_new.log', level='debug')
...
def add_db(title, content, file_name):
    sql = """INSERT INTO wiki_en (title,content, file_name, origin) VALUES (%s, %s, %s, %s)"""
